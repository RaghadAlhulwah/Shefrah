...
public class Shefrah1 {
    ...
    private static ArrayList <ShClient> waitingRoom = new ArrayList<>();  //array that store connected players (waiting list)
    private static ArrayList <ShClient> playingRoom = new ArrayList<>();  //array that store players in the game (players list)
